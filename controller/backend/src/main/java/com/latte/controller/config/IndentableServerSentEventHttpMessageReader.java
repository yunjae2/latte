...
public class IndentableServerSentEventHttpMessageReader implements HttpMessageReader<Object> {
     ...
     */
    public IndentableServerSentEventHttpMessageReader() {
        this(null);
    }
     ...
     */
    public IndentableServerSentEventHttpMessageReader(@Nullable Decoder<?> decoder) {
    ...
    private Object buildEvent(List<String> lines, ResolvableType valueType, boolean shouldWrap,
        ...
        for (String line : lines) {
            if (line.startsWith("data:")) {
                ...
                data.append(line.substring(5).stripTrailing()).append('\n');
            }
            if (shouldWrap) {
